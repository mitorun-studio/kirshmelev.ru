...
module.exports = function(eleventyConfig) {
	...
	return {
		pathPrefix: '/kirshmelev.ru/',// Тут можно указать дополнение к ссылкам (например имя репозитория на GitHub) и оно будет подставляться к локальным ссылкам с помощью плагина html-base.
