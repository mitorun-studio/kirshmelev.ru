...
module.exports = function(eleventyConfig) {
	...
	return {
		pathPrefix: '/kirshmelev.ru/', // Можно указать дополнение к ссылкам и использовать через фильтр "| url", например имя репозитория на Github (но для этого лучше использовать плагин html-base).
